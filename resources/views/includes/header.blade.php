	                ...
	                <div id="menu-container">
	                    ...
	                    <nav id="main-menu">
                            ...
                            <ul class="menu">
                                ...
                                <li class="menu-item-megamenu-parent megamenu-4-columns-group menu-item-depth-0"><a href="{{asset('photo')}}">Фото</a></li>
	                            <li class="menu-item-simple-parent"><a href="{{asset('video')}}">Видео</a>
                                	<ul class="sub-menu">
                                        <li class="menu-item-simple-parent current_page_item menu-item-depth-0"><a href="headers.html">Headers</a></li>
                                        <li class="menu-item-simple-parent menu-item-depth-0"><a href="footer1.html">Footers</a></li>
	                            ...
	                            <li class="menu-item-megamenu-parent megamenu-4-columns-group menu-item-depth-0"><a href="{{asset('populars')}}">Блог</a></li>
	                            <li class="menu-item-megamenu-parent megamenu-5-columns-group menu-item-depth-0"><a href="portfolio-4-column-with-space.html">Галерея</a>
